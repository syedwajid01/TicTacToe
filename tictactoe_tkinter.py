from tkinter import Label,Grid,Button,Tk,messagebox
...
lb2=Label(window,text="Player 1: X",font=('Helvetica','10'))
lb2.grid(row=2,column=0)
lb3=Label(window,text="Player 2: O",font=('Helvetica','10'))
